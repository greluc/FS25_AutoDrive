...
-- Lua 5.4 rejects a float with no integer representation here, and os.clock()*1E11 is a float,
-- so this raised "number has no integer representation" on some runs and not others depending on
-- the clock value. Truncating makes it deterministic across 5.1 through 5.4.
